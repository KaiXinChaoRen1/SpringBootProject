...
import com.lwq.jk2_JPA.entity.yanTest.A;
import com.lwq.jk2_JPA.entity.yanTest.ADao;
...
public class LayersTest {
    ...
    // @ManyToOne(cascade = CascadeType.ALL) //或cascade
    // ={CascadeType.PERSIST,CascadeType.MERGE},只有PERSIST会报错
    // @JoinColumn
    // private A parentA;
    @Test
    @Transactional
