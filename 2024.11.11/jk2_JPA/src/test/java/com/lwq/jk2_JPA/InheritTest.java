...
import com.lwq.jk2_JPA.dao.inheritRepository.ColorRepository;
import com.lwq.jk2_JPA.dao.inheritRepository.DijiaRepository;
import com.lwq.jk2_JPA.dao.inheritRepository.FastDijiaRepository;
import com.lwq.jk2_JPA.dao.inheritRepository.StrongDijiaRepository;
import com.lwq.jk2_JPA.entity.inherit.Color;
import com.lwq.jk2_JPA.entity.inherit.Dijia;
import com.lwq.jk2_JPA.entity.inherit.FastDijia;
import com.lwq.jk2_JPA.entity.inherit.StrongDijia;
...
public class InheritTest {
    ...
    // StrongDijia sd =
    // StrongDijia.builder().uuid(snowflake.nextIdStr()).power(100).speed(80).skill("迪拉修姆光流")
    // .favorite(true).build();
    // FastDijia fd =
    // FastDijia.builder().uuid(snowflake.nextIdStr()).power(80).speed(100).skill("兰帕尔特光弹").build();

    // Color blue =
    // Color.builder().uuid(snowflake.nextIdStr()).value("蓝色").dijia(fd).build();
    // Color red =
    // Color.builder().uuid(snowflake.nextIdStr()).value("红色").dijia(sd).build();
    ...
    // Dijia d =
    // Dijia.builder().uuid(snowflake.nextIdStr()).power(90).speed(90).build();
    // dr.save(d);
    ...
    // FastDijia fd =
    // FastDijia.builder().uuid(snowflake.nextIdStr()).power(80).speed(100).skill("兰帕尔特光弹").color(blue)
    // .build();
